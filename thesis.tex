...
\textit{Matthieu Doutreligne, Tristan Struja, Judith Abecassis, Claire Morgand, Gaël
  ...
  decision making.} \\
As the first author I designed the study, performed the experiments and wrote
the manuscript.
...
\paragraph{Causal thinking} The key ingredient to ground data-driven decision making is
...
\begin{figure}
  ...
  \caption{The five categories of causal variables needed for our
    framework.}\label{fig:causal_variables}\md{Might take some work to put this figure in a colourbox.}
\end{figure}
...
\autoref{subsec:causal_tuto:framing}, a large eligibility period
...
aggregations (\autoref{subsec:causal_tuto:estimation}). These challenges can create
subtle causal biases (\autoref{subsec:causal_tuto:framing}).
%
