...
\begin{background_box_left}
  ...
  It is concerned with empirical risk minimization: Finding good approximation
  of the features-outcome association. I recall the formal definition of the
  regression problem here and I refer to \cite{hastie2009elements} for the
  ...
  that it has been trained on, we would favor systematically flexible models
...
\begin{background_box_left}
  ...
  \citep{krizhevsky2012imagenet}, sparkled interest for representation
  learning.
  \md{complete here taking inspiration from Gael slideware or alexis thesis}.
  ...
  representation loops back to the choice of a model, and hence of the measure
  of performances for relevant downstream tasks. For other domains such as NLP,
  consensus tasks such as text classification have been found to evaluate the
  relevance of representation techniques. Aggregated in benchmarks such as GLUE
  \citep{wang2018glue}, these tasks fueled model developments for years.
  ...
  objectives --what they call construct validity. This concerns is much greater
  for RWDs since interests in using these data are fragmented--as developed in
  ...
  for confidentiality purposes. These specific features of RWD all into question
  the appropriateness of constructing universal representations in healthcare.
