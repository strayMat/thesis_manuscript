...
variy among the different healthcare actors.
...
give more time to the physicians by accellerating and faciliting parts of their
work that require poor analatical capacities. Old example of such automation is
...
% this is where I clearlly state what are my questions ? 
...
\subsection{What are we intersted in ?}\label{subsec:intro:questions}

\paragraph{Modern healtcare issues}

The Coming revolution In Medecine is desribed in the 70's as \citep{rutstein1967coming}:
\textit{1) modern medicine's skyrocketing costs; 2) the chaos of an information
  explosion involving both paperwork pro- liferation and large amounts of new
  knowledge that no single physician could hope to digest; 3) a geographic
  maldistribution of MD's; 4) increasing demands on the physician's time as
  increasing numbers of individuals began to demand quality medical care.} Fifty
years later, the same preoccupations are destabilizing healthcare systems in
rich countries: costs, lack of trained physicians, geographic disparities, ever
...
place in clinical medecine. In the same paper, Mario Stefanelli insists on the
...
\md{Place here the pubmed per year graph. What relevant questions ? What relevenat methodological tools?}

We reproduced the graph from \citep[Chapter 1]{steyerberg2009applications}.
...
More recently, \cite{beam2018big} devises a Machine-learning spectrum, making
...
task, this thesis questions what models and concepts are useful for healthcare.
...
precise scope of CDWs is still poorly undestood: How are they created ? What
...
\begin{chapterabstract}\label{sec:causal_tuto:abstract}%
  ...
  considerations in analysing EHRs or claims data to draw causal conclusions. We
