...
%
The concept of big data made its way into the direction of statistics of the
French ministry of health. Short before my arrival in 2018, they extracted billions of
national claims from the aging national health platform into a dedicated server.
%
...
\ref{fig:tsne_plots:snds}). Comparing the relationships between events captured
by these low dimensional to known associations was striking. But I was
...
representation or predictive accuracy. Public services wanted to understand the
heterogeneities in healthcare consumptions: what is an appropriate care and how
to measure it from the data \citep{cma_policy_appropriateness_2015}? This
question was motivated by the growing necessity to adapt healthcare funding to a
...
\paragraph{\textit{Data looking for a question [...] and rais[ing] puzzles}, D. Cox}%
