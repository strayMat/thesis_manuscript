...
\begin{chapterabstract}[Abstract]
  ...
  Clinical Data Warehouses (CDWs). It highlights key aspects of this cornerstone
  infrastructure for the collect and analysis of Electronic Health Records
  (EHRs).
  ...
  Anchored in causal thinking, chapter \ref{chapter:predictive_models} details
  key elements necessary to robustly estimate treatment effect from time-varying
  EHR data. Despite a current focus on artificial intelligence, healthcare does
  ...
  \ref{chapter:causal_model_selection} demonstrates the fragility of the usual
  evaluation metrics (Mean Squared Error) for counterfactual predictions. I
  highlight the performance of the doubly robust R-risk over other existing
  risks and discuss their effectiveness regimes in a simulation and three
  semi-simulated datasets.

  Chapter \ref{chapter:conclusion} discuss potentially interesting avenues to
...
In the following section, I will review the new data collection mechanisms,
...
these causal risk has not been empirically evaluated in a wide variety of
