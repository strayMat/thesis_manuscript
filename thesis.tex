...
\begin{chapterabstract}[Abstract]
  ...
  simulation and three semi-simulated datasets, we show that the usual machine
...
\begin{chapterabstract}[Résumé en français]
  ...
  d'hyperparamètres pour les modèles causaux est cruciale afin d'éviter le
  sous-apprentissage ou le sur-apprentissage. Grâce à une simulation et trois
  ensembles de données semi-simulées, nous montrons que le risque usuel en
  apprentissage statistique n'est pas adapté au cadre causal et que le risque R
  doublement robuste surpasse d'autres risques causaux existants.
\end{chapterabstract}
\vfill
