...
The \emph{Coming revolution In Medecine} is described in the late 60's as
...
Collection and analysis of new types of data is at the croassroads of
...
Pubmed papers mentionning predictive modeling, I constrat the exponential
increase of such articles with the concurrent drop in the use of causality terms
on Pubmed. 

\begin{figure}
  \includegraphics[width=\textwidth]{img/chapter_1/pubmed_query.pdf}
...
increase in predictive power can serve the true objective of healtcare:
