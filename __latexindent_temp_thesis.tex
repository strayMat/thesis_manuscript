...
% Encadrants
Merci avant tout à toi, Gaël. Merci pour ta confiance, merci pour ta présence
continue et bienveillante. Merci pour les conseils, les encouragements, les
relectures tardives. Merci de m'avoir pousser à chercher les bonnes questions et à
montrer pourquoi celles-ci sont importantes. Je n'aurais pas pu rêver d'un
meilleur directeur de thèse. 

Merci à Claire d'avoir été là. Ca n'a pas toujours été facile de garder le contact
à distance, mais nos discussions et tes conseils ont été précieux. 
% 
Un immense merci à Pierre-Alain, qui a été un manager toujours bienveillant et
attentif, et un très grand exemple de rigueur. J'espère continuer à partager ton
enthousiasme et ton recul critique pour tous les sujets de données de santé. 
% Inria
Merci à toutes les personnes croisées à l'Inria dans ces merveilleuses équipes
MIND -- SODA. Merci à tous les PI, post-docs: Marine, Judith, Jill-Jenn, Thomas
(team café moulu), . Et merci également à tous les occupants occasionnels de
l'open-space doctorant: Alexis, Alex, Julie, Cédric et Benoît, Vincent. Merci
pour les discussions passionantes que ce soit sur les plans scientifiques ou
juste de café de comptoir. Merci Théo pour les discussions et les soutiens
galères sur l'entrepôt de l'AP. 
% APHP
Merci à toute l'équipe de Data Science de l'APHP pour leur accueil les jeudis :
Romain, Thomas, Perceval, Ariel, Etienne, Adam, Christelle, et ceux que j'oublie.
% HAS
...
\gv{Small populations: no silver bullet. Il faut qu'on parle d'abord de petites
  populations. Ensuite on peut parler de transfer learning. Donner plus de poids
  aux faibles number of cases.}%
