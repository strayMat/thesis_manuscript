...
% lefthandside background information box
...
\newtcolorbox{background_box_left}[1][]{
  mytitle=\textcolor{background_info_color}{Background},
...
\begin{titlepage}
  ...
  \color{Prune}
  \fontfamily{cmss}\fontseries{m}\fontsize{22}{26}\selectfont Représentations et
...
\begin{figure}[!tb]
  \centering
  \includegraphics[width=0.8\linewidth]{img/chapter_5/_3_procedure_r_risk_only_3datasets.pdf}
...
\begin{figure}[!tb]
  \centering
  \includegraphics[width=0.8\linewidth]{img/chapter_5/_4_nuisance_models_r_risk_only_3datasets.pdf}
