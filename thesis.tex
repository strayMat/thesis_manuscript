...
\begin{appendices}
  ...
  \begin{background_box_left}
    ...
    \end{align*}
    The same calcuation with $A=0$ give the result. Note that this result does
    ...
    \begin{proof}[Unbiasdeness of the G-formula, \citep{robins_role_1986}]
    ...
    \begin{proof}[Unbiasdeness of IPW, \citep{rosenbaum_central_1983}]
      ...
      \begin{align*}
        \mathbb P[A=1 \mid Y(1), Y(0), e(X)] & = \mathbb E \big[\mathbb P[A=1 \mid Y(1), Y(0), X, e(X)] \mid  Y(1), Y(0), e(X) \big] &  & \text{Law of total expectation}                            \\
                                             & = \mathbb E \big[\mathbb P[A=1 \mid X] \mid  Y(1), Y(0), e(X) \big]                   &  & \text{ignorability and X contains all information of e(X)} \\
                                             & = \mathbb E \big[ e(X) \mid \mid  Y(1), Y(0), e(X) \big ]                             &  & \text{by definition of the propensity score}               \\
                                             & = e(X) \text{e(X) contains all information of e(X)}
      \end{align*}
