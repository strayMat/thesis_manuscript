...
These first experiences highlight a tension between a new scientific framework
--machine learning \citep{breiman2001statistical} described in
\ref{sec:intro:two_cultures}--, massive routine data collections in healthcare
--claims or EHRs detailed in \ref{sec:intro:data}-- and pressing analytical
questions in public health detailed in \ref{sec:intro:causality}. The successes
of machine learning in leveraging large amount of weakly labelled data in NLP or
natural image processing does not imply that it will be successful in other data
heavy domains. However, this claim has been made by many authors in the last
decade.
