...
discontinuity design \citep{bor2014regression} and instrumental variables \citep{}
...
deployment is almost unexistant. \md{source PA pour le non remboursement des
  DMs avec IA.} This forces us to rely on efficient techniques that make the
...
language to either extract information from clinical notes, or directly for
predictive tasks \citep{jiang2023health}.
...
back to causal thinking. How to build a causal graph as in Figure
\ref{fig:causal_diagram_albumin}? Optimizing directly the R-loss by gradient
descent could be an interesting avenue, which is closely related to the work of
