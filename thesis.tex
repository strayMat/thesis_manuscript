...
\begin{background_box_left}
  ...
  \paragraph{Health data is first collected for a primary use:  patient care.}
  EHRs are primarily used to record patients' state of health and their care
  (26). These might be shared within the healthcare team, but always with a view
  to caring for the patient whose data is collected. The use of a patient's data
  is said to be primary when it is used patient's care
  \footnote{\url{https://ec.europa.eu/commission/presscorner/detail/en/qanda_22_2712}}.


  \paragraph{Secondary uses do not directly concern patient care.} They are reuses
  of data for other purposes, such as research, activity indicators for the
  ...
  Some purposes can encompass both types of use, as in the case of learning
  systems that give rise to diagnosis, prognosis or decision-making tools. During
  the \textit{learning phase}, data from a set of patients is reused --secondary
  use-- to create the knowledge required to operate the tool. In production, the
  tool takes input data from a specific patient to improve his or her care
  --primary use. This concept is part of the learning health system \citep{mcginnis2013best},
  which aims to continuously improve the quality of care by integrating research
  and innovation into the care process.
...
\citep{hugo_2022}. In July 2022, the Ministry of Health opened a 50 million euros
...
\subsection{The multiplication of Clinical Data Warehouses}%
...
\citep{chute_enterprise_2010,pavlenko_implementation_2020}. Fig
...
\begin{figure*}[!h]
  \centering
  \includegraphics[width=0.7\linewidth]{img/chapter_2/Fig4.pdf}
...
\md{Might go into the conclusion}
