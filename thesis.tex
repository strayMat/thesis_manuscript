...
\begin{chapterabstract}\label{sec:causal_tuto:abstract}%
  ...
  chapter explores the causal framework to yield clinically valuable models. It
...
\md{might be a bit abrupt transition}
...
\begin{appendices}
  ...
  \chapter{Chapter 3}\label{apd:predictive_models}
