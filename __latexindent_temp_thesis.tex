...
%
\paragraph{Substantial efforts are needed to collect routine care data}

Vast amount of new data is collected in healthcare at the cost of new
infrastructures. Navigating through this mass data is simplified by . A lot of
hope, mainly in research, but also in applying to care. Very complicated to use
in practice, because of heterogeneity of data, local practices and resources.
