...
documented publicly (8/21). \subsection{Uneven transparency of ongoing
...
\paragraph{Today, CDWs are built predominantly for scientific research.}
...
\subsection{A multi-layered technical
  architecture}\label{subsec:cdw:results:architecture}
