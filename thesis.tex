...
\begin{background_box_left}
  ...
  In observational data, interventions are far from random. Interventions are
  generally given in priority to patient requiring care (as exemplified in
  Figure \ref{fig:toy_example}). Therefore treated and control populations
  differ in ways that prevents the attribution of outcome difference to the sole
  treatment. Such differences call for dedicated adjustments presented in
  Section \ref{subsec:causal_tuto:estimation}. 
  ...
  comorbidities, adhering to the treatment. These factors contribute to
