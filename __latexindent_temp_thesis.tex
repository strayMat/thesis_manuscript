...
infrastructures. Navigating through this mass of data is simplified moslty by
NLP techniques. Mainly sold for research, creating new evidences is hard because
of the poor normalization of data, and unexhaustive collect of critical elements
of the healthcare trajectories even during hospital care, heterogeneity of local
practices and resources.


\paragraph{These data repositories are not big enough} Even a regional scale
data center such as the AP-HP has a small number of cases for common pathologies
such as cardiovascular adverse events as \ref{chapter:predictive_models} shows.
On these medium sized datasets, simple flexible models --based on forest-- are doing
better than transformer-based models.
