...
\begin{chapterabstract}\label{sec:causal_tuto:abstract}%
  ...
  chapter explores the causal framework Accurate predictions, as with machine learning, may not suffice to
  ...
  analysing EHRs or claims data to draw causal conclusions. We illustrate the
