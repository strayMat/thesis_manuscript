...
observational data (detailed in Subsection
...
Building upon the work of \cite{bacry2020scalpel3}, I learned that distributed
...
\subsection{\textit{Data looking for a question [...] and rais[ing] puzzles}}%
\label{subsec:intro:wrapup}%

These first experiences illustrate a tension between massive routine care data
collections --claims or EHRs detailed in Section \ref{sec:intro:data}, a new
scientific framework --machine learning \citep{breiman2001statistical} described
...
The successes of machine learning in leveraging large amount of weakly labelled
data in NLP or natural image processing does not imply that it will be
successful in other data heavy domains. However, this claim has been made by
many authors in the last decade with a poor practical implementation in a
context of steady increase in healthcare costs \citep{mcginnis2013best,
  data_oecd_health_spending}.

\md{Might add a citation for poor implementation of ML in healthcare}

% Here promises of machine learning in healthcare ?
...
\begin{background_box_left}
  ...
  The gold standard for generating new evidence in medicine are Random Control
  Trials (RCTs). Based on the randomization of patients to a treatment or
  control group, the data collection is designed for a precise research question
  --an experiment. Modern trial methodology is at the core of the \emph{evidence
    based medicine}, that supersede RCTs over natural experiments or expert
  opinions in a hierarchy of evidence \citep{guyatt1995users}. Their methodology
  has been shaped the large-scale International Studies of Infarct Survival
  (ISIS) trials \citep{isis_randomised_1986}. Two other research data
  ...
  Healthcare data is increasingly collected in electronic form from information
  ...
  Two major sources of Real World Data (RWD) \citep{fda_real-world_2021} are claims and EHRs.
  ...
  background or reason for seeking care. Finally, billing optimization processes
