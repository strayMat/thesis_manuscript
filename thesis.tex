...
\begin{chapterabstract}\label{sec:predictive_models:abstract}%
  ...
  makes frugal models particularly attractive because of their capacity to
  learn from few examples. Despite being attractive for large samples, complex
  models, as with transformers may be less adpated to typical clinical settings
  than lightweight data-processing pipelines using tree-based models.
\end{chapterabstract}
...
this ever richer data sources gain in complexity. We explore a
performance-complexity tradeoff in predictive models on three tasks ranging
from general populations of patients to more specific clinical cases.
