...
\paragraph{Poor adoption of common standards} The more heterogeneous a HIS system is, the less qualitative the CDW built above it will be. There is a need for increasing interoperability, to help EHR
...
preprocessing usually require to map non standard terminologies, create derived
...
effectiveness. To improve the robustness of these proofs, we need to test these systems on different prospective populations with intuitive metrics
...
performant. We propose a new model based on the transfer of static medical
