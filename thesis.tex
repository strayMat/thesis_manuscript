...
\md{move the personal experience in a dedicated section above. Only keep the gist and the subsection 1.1.4}
...
landscape and my prior experiences with healthcare data. An overview of these
circumstances should be helpful to understand why focus on health
...
% apport
Yet, routine care data is not a familiar material for medical research. In
circle of engineers and NLP researchers, this fact is often linked to the novel
complexity and scale of the data collection process, both requiring innovating
tools. For epidemiologists and physicians, their major difference lies in the
