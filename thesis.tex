...
% define colors for soul highligting
\usepackage{soul}
...
\begin{background_box_left}
  ...
  with decreasing financial supports. \cite{casey2016using} estimated \hl{the
...
\begin{background_box_left}
  ...
  \hl{For example, only 6\% of asthmatics would have been eligible for their own
...
established theory. \hl{Crowdsourcing studies asking the same question to
...
\cite{rutstein1967coming} as:\textit{1) modern medicine's skyrocketing costs; 2)
  ...
  quality medical care.} \hl{Fifty years later, the same preoccupations are
...
old and multimorbid \citep{skou2022multimorbidity}. \hl{Fewer than half of the
