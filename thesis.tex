...
% chapter 4
Predictive models --\emph{eg} from machine learning-- give likely outcomes, but
they do not apply bluntly to decision making, choosing whether to treat
or not to treat. Such reasoning on the effect of an intervention is a
causal-inference task. I demonstrated that causal thinking was necessary to
avoid introducing biases in the study design or during confounders selection.

% Even with causal framework, there are too many models to choose from
Even with a robust causal framework, choosing among the plethora of predictive
models available for health data is not trivial. In a given situation, which
of these models yield the most valid causal estimates?
% scope of the paper 
Here, I highlight that classic machine-learning model selection does not pick
...
% Contributions
Drawing from an extensive empirical study, I outline an efficient causal
...
\vfill
\textit{This chapter has been submitted to Artificial Intelligence in Medicine
  as:\\ Matthieu Doutreligne, Gaël Varoquaux. How to select predictive models for
  decision making or causal inference?. 2023. ⟨hal-03946902v3⟩. \\ As the first
  author I formulated the research question, designed the study, did the proves
...
\begin{background_box_left}
  ...
  \md{duplicated with chapter 4: move back there, and only refer to it here.}
...
\begin{appendices}
  ...
  \begin{figure}
    \includegraphics[width=\linewidth]{img/chapter_5/_4_nuisance_models_r_risk_only_twins_nuisances.png}
    \hfill
