...
\begin{chapterabstract}[Abstract]
  ...
  \gv{poser une question générale et être plus court sur chaque chapitre.}
...
medical events used in this data. This problem known as the \emp{curse of
...
\paragraph{Chapter \ref{chapter:causal_tuto}: Prediction is not all we need:
  Causal thinking for decision making on EHRs} This chapter explores the causal
